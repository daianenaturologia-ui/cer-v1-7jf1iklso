...
export const MENTE_EMOCOES_EXPERIENCE: CerExperienceRecord = {
  ...
  subtitle: 'Investigação do seu funcionamento habitual e repetido ao longo dos últimos anos.',
  order_index: 3,
  is_pilot: false,
  opening_text:
...
export const BUILD_07C_MENTE_PROMPTS: CerPromptRecord[] = [
    ...
    schema_config: {
      ...
      option_set: {
        ...
        items: [
          ...
          {
            id: 'penso_analiso_antes',
            label: 'Costumo pensar e analisar antes de conseguir sentir.',
          },
          ...
          {
            id: 'permanecem_bastante',
            label: 'Algumas emoções permanecem comigo por bastante tempo.',
          },
  ...
  // PERGUNTA 2
  {
    ...
    helper_text:
      'Escolha até quatro que você reconhece com maior frequência no seu funcionamento habitual.',
    is_required: true,
    version: 2,
    schema_config: {
    ...
    schema_config: {
      ...
      options: [
        ...
        },
        {
          ...
          title:
            'Procuro distração no celular, nas compras, na comida, em séries ou em outras atividades.',
        },
        {
    ...
    schema_config: {
      ...
      options: [
        ...
        },
        {
          ...
          title:
            'Consigo organizar e realizar o que é importante sem me pressionar excessivamente.',
        },
        {
  ...
  // PERGUNTA 11
  {
    ...
    schema_config: {
      ...
      option_set: {
        ...
        items: [
          {
            id: 'alerta_preocupado',
            label: 'Fico mais alerta ou preocupado com o que pode acontecer.',
          },
          ...
          {
            id: 'dificuldade_perceber_recursos',
            label: 'Sinto dificuldade de perceber meus recursos.',
          },
