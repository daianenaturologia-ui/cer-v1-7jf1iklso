...
export const AuditSecurityPanel: React.FC = () => {
  ...
  const handleRunTests = async () => {
    setRunning(true)
    try {
      const [res01, res02, res03a, res03b, res03c, res04a, res04b, res04c] = await Promise.all([
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base font-semibold">
                Auditoria de Segurança, Engine, Conhecimento, Sessões & Presentation (Builds 01–04C)
              </CardTitle>
            </div>
