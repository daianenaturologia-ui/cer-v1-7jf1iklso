...
export const AuditSecurityPanel: React.FC = () => {
  ...
  const handleRunTests = async () => {
    setRunning(true)
    try {
      const [res01, res02, res03a, res03b] = await Promise.all([
  ...
  const allResults = [...b01Results, ...b02Results, ...b03aResults, ...b03bResults]
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base font-semibold">
                Auditoria de Segurança, Engine & Conhecimento Longitudinal (Builds 01, 02, 03A e
                03B)
              </CardTitle>
            </div>
